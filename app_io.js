...
Blockly.Blocks['io_pwm_write_var'] = {
    init: function() {
        ...
        this.setNextStatement(true, null);
        this.setColour(260);
        this.setTooltip("Write an analog value (PWM) to a pin using a variable");
        this.setHelpUrl("https://www.arduino.cc/reference/en/language/functions/analog-io/analogwrite/");
    }
};
...
Blockly.Blocks['io_pwm_write_num'] = {
    init: function() {
        ...
        this.setNextStatement(true, null);
        this.setColour(260);
        this.setTooltip("Write an analog value (PWM) to a pin using a number (3,5,6,9,10,11)");
        this.setHelpUrl("https://www.arduino.cc/reference/en/language/functions/analog-io/analogwrite/");
    }
};
...
Blockly.Blocks['io_analogread_num'] = {
    init: function() {
        ...
        this.setColour(260);
        this.setColour(260);
        this.setTooltip("Read an analog value (0-1023) from an analog pin using a number (A0-A5)");
        this.setHelpUrl("https://www.arduino.cc/reference/en/language/functions/analog-io/analogread/");
    }
}; 